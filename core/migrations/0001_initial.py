# Generated by Django 3.1 on 2020-08-22 14:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('S', 'Samsung'), ('X', 'Xiaomi'), ('N', 'Nokia'), ('A', 'Apple'), ('R', 'Realme'), ('Op', 'Oppo'), ('On', 'OnePlus')], max_length=2, null=True)),
                ('item_type', models.CharField(blank=True, choices=[('B', 'BestSeller'), ('N', 'New'), ('D', 'Discount')], max_length=2, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bkash_payment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.bkaspayment')),
